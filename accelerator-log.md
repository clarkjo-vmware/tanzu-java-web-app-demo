...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=clarkjo-vmware&repo=tanzu-java-web-app-demo",
  "includeBuildToolWrapper" : true,
  "javaVersion" : "17",
  "projectName" : "tanzu-java-web-app-demo",
  "repositoryPrefix" : "tanzu-java-web-app-demo",
  "updateBoot3" : true
}
```
## Log
...
┃ ┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [your-registry.io/project->tanzu-java-web-app-d...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=clarkjo-vmware&repo=tanzu-java-web-app-demo'
